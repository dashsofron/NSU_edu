...
{
	Level level;
	level.LoadFromFile("nfg.tmx");

	sf::RenderWindow window;
	window.create(sf::VideoMode(640, 320), "Level.h test");
	...
	while (window.isOpen())
	{
		...
		while (window.pollEvent(evt))
		{
			...
			case sf::Event::KeyPressed:
				...
				view.setCenter(pos.x + 1900 / 4, pos.y + 800 / 4);
				window.setView(view);
